...
"$generate_appcast" \
    ...
    --download-url-prefix "https://mtus.lieniapp.work/downloads/" \
    --embed-release-notes \
...
"$project_dir/scripts/project-python.sh" "$project_dir/scripts/bind-release-metadata.py" \
    ...
    --signature "$notes_signature" --base-url "https://mtus.lieniapp.work" \
...
manifest = {
    ...
    "downloadURL": f"https://mtus.lieniapp.work/downloads/{archive_name}",
}
